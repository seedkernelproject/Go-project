...
func main() {
	...
	http.Handle("/Volumes/SeagateBackup-Kelvin/Go/Google Cloud/src/welcome-app/static/", //final url can be anything
		http.StripPrefix("/Volumes/SeagateBackup-Kelvin/Go/Google Cloud/src/welcome-app/static/",
